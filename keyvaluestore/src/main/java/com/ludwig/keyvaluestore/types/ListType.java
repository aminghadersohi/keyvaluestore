...
public interface ListType<T> {
     ...
     */
    @NonNull
    Single<List<T>> observePut(@NonNull final List<T> list);

    /**
     * Asynchronously write a {@code List} to this store. The write operation occurs on {@link
     * Schedulers#io()}. If you wish to specify the {@link Scheduler} then use {@link #put(ListType,
     * Scheduler)}.
     */
     ...
     */
    @NonNull
    Single<List<T>> observeAdd(@NonNull final T value);
     ...
     */
    @NonNull
    Single<List<T>> observeRemove(@NonNull final PredicateFunc<T> predicateFunc);

    /**
     * Asynchronously attempt to remove all items matching criteria from the {@code List}.
     * This method removes all items for which the predicate function returns true.
     * <p>
     ...
     */
    Single<List<T>> observeRemoveAll(@NonNull PredicateFunc<T> predicateFunc);
     ...
     */
    @NonNull
    Single<List<T>> observeRemove(@NonNull final T value);
     ...
     */
    @NonNull
    Single<List<T>> observeReplace(@NonNull final T value,
     ...
     */
    @NonNull
    Single<List<T>> observeAddOrReplace(@NonNull final T value,
                                        @NonNull final PredicateFunc<T> predicateFunc);
