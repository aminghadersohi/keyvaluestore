...
public interface ListType<T> {
    ...
    Single<List<T>> observeReplace(final T value,
     ...
     * replaces the first item for which the predicate function returns true.
     */
    void replace(T value, Scheduler scheduler,
    ...
    Single<List<T>> observeAddOrReplace(final T value,
                                        final PredicateFunc<T> predicateFunc);
     ...
     */
    void addOrReplace(T value, Scheduler scheduler,
                      PredicateFunc<T> predicateFunc);
